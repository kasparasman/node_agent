...
import { IDLE_BITRATE_THRESHOLD, IDLE_AUDIO_BITRATE_THRESHOLD } from "./config.js";
import { RTCPeerConnection } from '@roamhq/wrtc';
import { mediaEvents } from './emitter.js';
import { SharedState } from "./main_agent.js";
...
export function monitorVideoTrack(event: RTCTrackEvent, peerConnection: RTCPeerConnection, statusMessage: string, shared: SharedState): void {
...
export function monitorAudioTrack(event: RTCTrackEvent, peerConnection: RTCPeerConnection, statusMessage: string, shared: SharedState): void {
