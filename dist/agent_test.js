...
import { LocalVideoTrack, VideoSource, TrackSource, AudioSource, LocalAudioTrack } from '@livekit/rtc-node';
//@ts-ignore
...
async function processAudioFrame(frameBuffer) {
...
async function handleIncomingAudio(data, livekitAudioSource) {
    try {
